...
function draw() {
  ...
  //Loop through cities
	for (var i = 0; i < 2/*cities.length*/; i++) {
		...
		var img = b.image("cb.jpg", -100, -150, b.width+200, b.height+300);
		...
		var img = b.image("cb.jpg", -100, -150, b.width+200, b.height+300);
		img.geometricBounds = [b.height-gridH*2,0, b.height, b.width];
		b.imageMode(b.CENTER);
		b.image("logo3.png", b.width/2, b.height-(gridH), b.min(gridH, 60)*12.020, b.min(gridH, 60));
		b.imageMode(b.CORNER);
		...
		for (var j = 2; j<rows-2; j++) {
			/*
			if(j==b.round(rows/2)-1) {
				var img = b.image("cb.jpg", -100, -150, b.width+200, b.height+300);
				img.geometricBounds = [j*gridH,0, (j+1)*gridH, b.width];

				b.fill(255,75,75);
				b.text(cities[i].name.toUpperCase() + "    |    " + cities[i].date.toUpperCase() + "    |    " + cities[i].location.toUpperCase(), 50, j*gridH, b.width-100, gridH);
				b.fill(255,255,255);
			} else { */
				...
				var img = b.image("cb.jpg", -100+offSet, -150, b.width+200, b.height+300);
				img.geometricBounds = [j*gridH,0, (j+1)*gridH, b.width];

				var txtBox = b.text(txt, 75+(offSet*4), j*gridH, b.width-150+(offSet*4), gridH);
